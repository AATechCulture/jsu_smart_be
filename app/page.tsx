...
import { Check, Bot , Wallet, Users } from "lucide-react";
import {
  Card,
  CardContent,
  CardDescription,
...
const pricingPlans = [
  {
    name: "Starter",
    description: "Perfect for improving your health",
    price: 'Free',
  ...
  {
    name: "Pro",
    description: "Great start to fitness goals",
    price: 9,
  ...
  {
    name: "Premium",
    description: "For those challenging fitness goals",
    price: 16,
        ...
        <div className="container mx-auto px-4 py-20 sm:py-28">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-10 text-xl text-muted-foreground">
              {siteConfig.description} Your all-in-one platform for AI health coaching, financial guidance, and community support
            </p>
